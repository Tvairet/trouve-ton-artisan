    ...
    return (
      <main>
        ...
        <section className="container my-5">
          ...
          <Link to="/listeArtisans" className="btn btn-primary">← Retour à la liste</Link>
        </section>
      </main>
    );
  }
        ...
        <div className="row g-4">
          ...
          <div className="col-12 col-lg-8">                       
            ...
            <ul className="list-inline text-muted mb-3">
              ...
              <li className="list-inline-item ms-3"><strong>Localisation :</strong> {artisan.city || "—"}</li>
            </ul>
          ...
          <div className="col-12 col-lg-4">
            ...
            <div className="mt-3">
              <Link to="/listeArtisans" className="btn btn-outline-secondary btn-sm">← Retour à la liste</Link>
            </div>
          </div>
        </div>
      </section>
